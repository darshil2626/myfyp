...
class sinn:
    ...
    def create_patch_centres_and_indices_and_values_and_boundary_splits(self, patch_dim, num_patches, boundary_fraction=0.5):
        ...
        # A patch of half-width t_left/t_right centred at t_c covers [t_c-t_left, t_c+t_right].
        # We keep only training indices that are safely in-bounds.
...
if __name__ == "__main__":
    ...
    l2_reg = 1e-5
    lr = 1e-3
    patch_dim = [10, 10, 1]  # [px, py, pt] - spatial_x, spatial_y, time dimensions
    num_patches = 200
    epochs = 50
