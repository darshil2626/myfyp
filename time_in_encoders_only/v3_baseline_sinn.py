...
if __name__ == "__main__":
    ...
    solver.plot_training_history(loss_history, save_path="training_loss_v3b.png", show=True)
    ...
    solver.plot_test_mae_over_time(test_summary["per_step"], save_path="test_mae_over_time_v3b.png")
    ...
    solver.save_test_results(save_path="test_results_v3b.pkl",
