...
if __name__ == "__main__":
    # ---- Config ----
    b_thick = 2            # was 1 — thicker boundary = more observed data
    include_t0 = True
    include_tT = True
    num_latentdim = 10
    num_units = 128
    ...
    num_patches = 100
    epochs = 100           # was 50 — allow fuller convergence
    n_past_steps = 5
    train_fraction = 0.8
    mask_radius = 2        # was 1 — larger receptive field for encoders & source
    ...
    solver.mask_radius = mask_radius  # must be set before build_models
    ...
    print(f"  Mask radius: {solver.mask_radius} ({2*solver.mask_radius+1}x{2*solver.mask_radius+1} window)")
